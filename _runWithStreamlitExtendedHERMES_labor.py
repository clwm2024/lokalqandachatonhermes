...
import torch
print("loading transformers 1")
#from transformers import ElectraTokenizer, ElectraForQuestionAnswering
import transformers
print("loading transformers 2")
...
def get_response_from_local_model(prompt,context):
    ...
    tokenizer = transformers.ElectraTokenizer.from_pretrained("Sahajtomar/German-question-answer-Electra")
    model = transformers.ElectraForQuestionAnswering.from_pretrained("Sahajtomar/German-question-answer-Electra")
